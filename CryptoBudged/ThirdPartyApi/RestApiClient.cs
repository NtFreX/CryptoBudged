...
{
    // handle request limit break; security
    public abstract class RestApiClient
    {
        ...
        protected RestApiClient(int breakedRequestLimitStatusCode, int delayAfterBreakedRequestLimit, (string Name, Func<object[], string> UriBuilder, TimeSpan MaxInterval, TimeSpan CachingTime, int Retries, int[] StatusCodesToRetry)[] endpoints)
        {
